...
import Common_Methods.get_Common_Method_API;
import Common_Methods.get_Common_Method_Utilities;
...
public class get_TC1 {
	...
	public static void orchestrator() throws IOException
	{
		...
		for(int i=0; i<5; i++)
		{
			res_StatusCode=get_Common_Method_API.responseStatusCode_Extractor(baseURI, resource);
			if(res_StatusCode==200)
			{
				responseBody=get_Common_Method_API.responseBody_Extractor(baseURI, resource);
